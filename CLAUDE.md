...
Expected artifacts for project 001 (Cross-Government AI Governance Framework):
...
UK Government central department. Applicable frameworks: GDS Service Standard, Technology Code of Practice (TCoP), NCSC Cyber Assessment Framework, ATRS for AI tools, UK GDPR, HM Treasury Green Book, AI Playbook, Central Digital & Data Office (CDDO) standards.
